...
class Barrio
{
     ...
     * @return string
     */
    public static function error(string $txt)
    {
     ...
     * @return string
     */
    public static function info(string $txt)
    {
        $content = "<span style=\"display: inline-block; background: #2196F3; color: white; padding: 4px 10px; border-radius: 4px; font-family: 'Lucida Console', Monaco, monospace, sans-serif; font-size: 80%\"><b style=\"color:#FFEB3B;\">Info</b>: {$txt}</span>";
     ...
     *
     *  <code>
     *      Barrio::addAction('demo',function(){});
     *  </code>
     *
     ...
     *
     *  <code>
     *      Barrio::addShortcode('demo',function($args){
     *              // shortcode
     *      });
     *  </code>
     *
     ...
     * @return <type> ( description_of_the_return_value )
     */
    public static function addShortcode($shortcode, $callback_function)
    {
    ...
    public static function parseShortcode($content)
    {
        ...
        return preg_replace_callback($pattern, 'self::handleShortcode', $content);
    }
     ...
     * @return <type> ( description_of_the_return_value
     */
    protected static function handleShortcode($matches)
    {
        $prefix = $matches[1];
        $suffix = $matches[6];
        $shortcode = $matches[2];
