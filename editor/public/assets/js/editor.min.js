...
(function () {
    ...
    var y = document.querySelector('#editor-area'),
     ...
     controls = {
        ...
        'link': function link() {
            ...
            var title = null;
            var url = null;
            var placeholder = 'Titulo del link';
            fakePrompt('Titulo:','dialog', 'Titulo del link', false, function (t) {
                title = t.replace('http:','');
                title = t.replace('https:','');
                fakePrompt('URL:','dialog', 'Pegar link aqui', true, function (link) {
        ...
        'image': function image() {
            fakePrompt('Image URL:','dialog', 'Pegar link aqui', true, function (r) {
                ...
                title = altText.replace('Http://','');
                title = altText.replace('Https://','');
                url = r.replace('http:','');
                url = r.replace('https:','');
                editor.insert('\n![' + title + '](' + url + ')\n');
    ...
    // fake prompt
    function fakePrompt(label, type, value, isRequired, callback) {
